...
export function validateOrderInput(value: unknown): OrderInput {
  ...
  return { submissionId, productSlug: text('productSlug', 120), fullName: text('fullName', 120), phone: rawPhone.replace(/^0/, '+213'), wilaya: text('wilaya', 80), commune: text('commune', 120), address: text('address', 300), quantity: quantity as number, notes: text('notes', 1000, false) || undefined, color: text('color', 40, false) || undefined, size: text('size', 20, false) || undefined, attribution }
}
